const pokemonNames = [
  ...
  "菊草叶", "火球鼠", "小锯鳄", "波克比", "玛力露丽", "赫拉克罗斯", "班吉拉斯", "洛奇亚",
  "凤王", "拉帝亚斯", "拉帝欧斯", "盖欧卡", "固拉多", "烈空坐", "基拉祈", "代欧奇希斯",
  "草苗龟", "小火焰猴", "波加曼", "路卡利欧", "烈咬陆鲨", "达克莱伊", "阿尔宙斯", "捷克罗姆",
  "莱希拉姆", "酋雷姆", "甲贺忍蛙", "烈箭鹰", "黏美龙", "哲尔尼亚斯", "伊裴尔塔尔", "基格尔德",
  "炽焰咆哮虎", "狙射树枭", "西狮海壬", "谜拟Q", "索罗亚克", "杖尾鳞甲龙", "奈克洛兹玛", "捷拉奥拉",
  "敲音猴", "炎兔儿", "泪眼蜥", "苍响", "藏玛然特", "无极汰那", "武道熊师", "蕾冠王",
  "新叶喵", "呆火鳄", "润水鸭", "故勒顿", "密勒顿", "赛富豪", "浩大鲸", "晶光花"
];
